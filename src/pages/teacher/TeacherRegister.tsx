      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-gray-900">Teacher Registration</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/teacher/login" className="text-green-600 hover:text-green-700 font-medium">
                  Sign in here
                </Link>
              </p>
            </div>
        ...
        <div className="mt-4 text-center">
          <Link to="/student/register" className="text-sm text-gray-600 hover:text-gray-800">
